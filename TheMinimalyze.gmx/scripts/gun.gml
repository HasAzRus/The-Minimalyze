///Gun
    ...
    {   
        ...
        bullet = instance_create(x + lengthdir_x(6, weap_dir), y + 2 + lengthdir_y(6, weap_dir), o_bullet);
        bullet2 = instance_create(x + lengthdir_x(6, weap_dir), y + lengthdir_y(6, weap_dir), o_bullet);
        repeat(2)
        {
        ...
        {
            damage = 4;
            motion_add(other.weap_dir - 2, 4 * other.alt_fire_spd);
    ...
    if key_weap_drop
    {
        ...
        {
            set_weapon = 0;
            used_weap = instance_create(x, y, o_gun_used);
            with(used_weap)
            {
                throwed = true;
        ...
        {
            set_weapon = 0;
            weap = instance_create(x - lengthdir_x(weap_drop_distance, weap_dir), y - lengthdir_y(weap_drop_distance, weap_dir), o_gun);
            with(weap)
            {
                ammo = other.ammo;
