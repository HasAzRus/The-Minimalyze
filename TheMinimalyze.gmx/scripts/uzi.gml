///Uzi
    ...
    if key_weap_drop
    {
        ...
        {
            set_weapon = 0;
            used_weap = instance_create(x, y, o_uzi_used);
            with(used_weap)
            {
                throwed = true;
        ...
        {
            set_weapon = 0;
            weap = instance_create(x - lengthdir_x(weap_drop_distance, weap_dir), y - lengthdir_y(weap_drop_distance, weap_dir), o_uzi);
            with(weap)
            {
                ammo = other.ammo;
